...
import { MerchantSignUpDto, ACCESS_TYPE } from '../../../types';
...
export default class MerchantSignUp extends GlobalView {
        ...
        <main id="home" class="flex items-center justify-center h-screen">
            <div class="relative pt-28  mx-auto">
                <div class="bg-white shadow-md rounded px-12 py-12 ">
                    ...
                    <form class="block text-sm" id="merchant-signup">
                        <div>
                            <div class="mt-6">
                            ...
                            <div class="inline-flex items-center mt-6">
                                <span class="text-gray-500 ml-2">Already have an account?</span> <a href="/merchant/login">Login</a>
                            </div>
                        </div>
...
const submitForm = async (e) => {
    ...
    let params: MerchantSignUpDto | Record<string, string> = {}
